...
Rectangle {
    ...
    property alias circleColor: progressBar.color

    property alias showPercentage: progressBar.showPercentage
    property string percentageSuffix: ""

    property alias autoChangeColor: progressBar.autoChangeColor

    property alias indeterminate: progressBar.indeterminate

    property alias value: progressBar.value

    property alias spinnerWidth: progressBar.spinnerWidth
    ...
    Controls.ProgressBar {
        ...
        transform: Scale {
            xScale: 1 / Screen.devicePixelRatio
            yScale: 1 / Screen.devicePixelRatio
        }
        ...
        style: ControlStyles.ProgressBarStyle {
            ...
            progress: Canvas {
                ...
                function drawSpinner() {
                    ...
                    ctx.lineWidth = control.spinnerWidth * Screen.devicePixelRatio
                    ctx.lineCap = "butt";
        ...
        SequentialAnimation {
            running: autoChangeColor && visible
            loops: Animation.Infinite
    ...
    MaterialLabel {
        ...
        text: (progressBar.value * 100).toFixed(0) + percentageSuffix
        font.pixelSize: (14)
    }
}
