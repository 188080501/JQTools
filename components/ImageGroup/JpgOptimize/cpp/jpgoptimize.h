...
#ifndef GROUP_IMAGEGROUP_JPGOPTIMIZE_CPP_JPGOPTIMIZE_H_
#define GROUP_IMAGEGROUP_JPGOPTIMIZE_CPP_JPGOPTIMIZE_H_
...
public slots:
    ...
    QString urlToLocalJpgFilePath(const QVariant &url);
...
#endif//GROUP_IMAGEGROUP_JPGOPTIMIZE_CPP_JPGOPTIMIZE_H_
