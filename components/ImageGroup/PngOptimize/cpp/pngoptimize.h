...
#ifndef GROUP_IMAGEGROUP_PNGOPTIMIZE_CPP_PNGOPTIMIZE_H_
#define GROUP_IMAGEGROUP_PNGOPTIMIZE_CPP_PNGOPTIMIZE_H_
...
#endif//GROUP_IMAGEGROUP_PNGOPTIMIZE_CPP_PNGOPTIMIZE_H_
